...
public class ajouterseance extends AppCompatActivity  {
    ...
    private static String URLclient= MainActivity.urlList;
    private static String URL= MainActivity.urlListMonitor;
            ...
            public void onClick(View v) {
                ...
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        PutData putData = new PutData(MainActivity.urlAddSeance, "POST", field, data);
                        if (putData.startPut()) {
